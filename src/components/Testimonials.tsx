...
const Testimonials: React.FC = () => {
  ...
  const testimonials: Testimonial[] = [
    {
      id: 1,
      quote: "Scuzi.in transformed our online presence! Their team is professional, creative, and delivered results beyond our expectations. Our website traffic increased by 110% within just 3 months.",
      name: "BES Group",
      company: "BES Online",
      position: " ",
      rating: 5
