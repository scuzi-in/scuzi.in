...
import { Search, MousePointer, Users, PenTool, Code, BarChart3, Target } from 'lucide-react';
  ...
  return <section id="services" className="section-padding" style={{ backgroundColor: '#dad7cd' }}>
      <div className="container-custom">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12">
          {services.map((service, index) => <div key={index} className="card-service group">
              {/* Service Icon */}
              ...
              <div className="space-y-2">
                {service.features.map((feature, featureIndex) => <div key={featureIndex} className="flex items-center text-sm text-gray-700">
